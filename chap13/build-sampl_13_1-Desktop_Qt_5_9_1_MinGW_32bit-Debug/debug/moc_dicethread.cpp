...
#include "../../sampl_13_1/dicethread.h"
...
QT_MOC_LITERAL(4, 26, 9) // "diceValue"
    ...
    "DiceThread\0newValued\0\0seq\0diceValue"
};
...
void DiceThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        DiceThread *_t = static_cast<DiceThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (DiceThread::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DiceThread::newValued)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DiceThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_DiceThread.data,
      qt_meta_data_DiceThread,  qt_static_metacall, nullptr, nullptr}
};
...
void *DiceThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DiceThread.stringdata0))
        return static_cast<void*>(const_cast< DiceThread*>(this));
