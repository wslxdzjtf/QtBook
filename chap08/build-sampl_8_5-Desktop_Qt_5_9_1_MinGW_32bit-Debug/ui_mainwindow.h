...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gView = new MyGraphicsView(centralWidget);
        gView->setObjectName(QStringLiteral("gView"));
        gView->setGeometry(QRect(70, 40, 256, 192));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "\347\273\230\345\233\276\350\275\257\344\273\266", Q_NULLPTR));
