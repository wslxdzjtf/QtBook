...
#include "../../sampl_8_5/mygraphicsview.h"
...
QT_MOC_LITERAL(5, 42, 16), // "mouseDoubleClick"
QT_MOC_LITERAL(6, 59, 5), // "point"
QT_MOC_LITERAL(7, 65, 12) // "mouseClicked"

    },
    "MyGraphicsView\0keyPress\0\0QKeyEvent*\0"
    "event\0mouseDoubleClick\0point\0mouseClicked"
};
...
void MyGraphicsView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (MyGraphicsView::*_t)(QKeyEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGraphicsView::keyPress)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MyGraphicsView::mouseDoubleClick)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MyGraphicsView::keyPress(QKeyEvent * _t1)
{
